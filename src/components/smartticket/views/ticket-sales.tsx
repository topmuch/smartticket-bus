        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Unit Ticket - only option now */}
              <button
                onClick={() => setCurrentStep(1)}
                className="relative p-6 rounded-xl border-2 text-left transition-all hover:shadow-md border-primary bg-primary/5 shadow-md"
              >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground bg-blue-50 border border-blue-200 rounded-lg p-3">
              Les informations passager sont optionnelles.
            </p>
