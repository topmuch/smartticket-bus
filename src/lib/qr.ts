...
export interface QRPayload {
  ...
  fromZone?: string;
  toZone?: string;
  // Departure-linked fields (regional system)
  departureId?: string;
  lineId?: string;
  scheduledTime?: string;
  departureDate?: string;
  validFrom?: number;       // validity start timestamp (seconds)
  validTo?: number;         // validity end timestamp (seconds)
}
