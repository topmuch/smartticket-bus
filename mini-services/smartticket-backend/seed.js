// ============================================
// SmartTicket Bus - Seed Data (better-sqlite3)
...
const seed = async () => {
  ...
  try {
    // better-sqlite3: init synchrone
    initDB();

    // Helper: run single SQL with params (better-sqlite3 API)
    ...
    // better-sqlite3 écrit automatiquement sur disque, pas besoin de saveDB()
