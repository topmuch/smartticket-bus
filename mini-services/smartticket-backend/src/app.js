...
const { checkConnection, initDB } = require('./config/db');
...
async function startServer() {
  // 1. Initialiser la base de données (better-sqlite3, synchrone)
  initDB();
  checkConnection();
  ...
  // ============================================
  // 6. better-sqlite3 écrit directement sur disque,
  // pas besoin de sauvegarde manuelle.
  // ============================================
